...
img.onload = () => {
  ...
  c2.width = 16;
  c2.height = 16;
  c2.getContext("2d").drawImage(img, 0, 0, 16, 16);
...
`;
writeFileSync("/workspace/.grok/favicon-preview/preview.html", html);
...
await page.goto("file:///workspace/.grok/favicon-preview/preview.html");
await page.waitForFunction(() => document.documentElement.dataset.ready === "1");
await page.screenshot({ path: "/workspace/.grok/favicon-preview/svg-raster.png" });
await browser.close();
console.log("ok");
